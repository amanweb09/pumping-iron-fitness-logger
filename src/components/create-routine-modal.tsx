...
interface PropTypes {
    setCreateRoutineModalOpen: React.Dispatch<React.SetStateAction<boolean>>
}

const CreateRoutineModal: React.FC<PropTypes> = ({ setCreateRoutineModalOpen }) => {
    ...
    async function createWorkout(e: React.MouseEvent<HTMLElement>) {
        ...
        return setCreateRoutineModalOpen(false)
    }
